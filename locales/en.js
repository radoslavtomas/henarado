export const en = {
  ...
  plan: {
    ...
    friday_plan: [
      ...
      'During the day, we will be making goulash (and then eating it 😊)',
      'In the evening, there will be a pre-wedding party – goulash, drinks getting to know each other (again), guitars'
    ],
    saturday: 'Saturday',
    saturday_plan: [
  ...
  practicalities: {
    ...
    gethere: 'How to get there',
    gethere_desc:
      "Most sensible transport option is by car, parking shouldn't be an issue, if not on site, then surely nearby. Another sensible option is to get to Liptovsky Mikulas, or even closer to Liptovsky Hradok, then take a taxi.",
    weather: 'Weather',
    weather_desc:
      'August in Slovakia shouldn’t disappoint, but just in case we ask you to keep your fingers crossed. Those in good books with their deities, add a prayer or two on this topic. Ta!',
    food: 'Food',
    food_desc:
